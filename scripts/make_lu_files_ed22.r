...
inpdir  = file.path("/Users/felicien/Documents/projects/ED2.regional.runs/data/LUHa_t1.v1/lu/")                    # Path with inputs
histdir = file.path("/Users/felicien/Documents/projects/ED2.regional.runs/data/LUHa_t1.v1/lu/")                  # Input path
...
# scp * hpc:/data/gent/vo/000/gvo00074/ED_common_data/land_use/LUH1/
